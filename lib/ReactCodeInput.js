...
/***/ function(module, exports, __webpack_require__) {
	...
	'use strict';Object.defineProperty(exports,"__esModule",{value:true});var _keys=__webpack_require__(1);var _keys2=_interopRequireDefault(_keys);var _assign=__webpack_require__(36);var _assign2=_interopRequireDefault(_assign);var _toConsumableArray2=__webpack_require__(42);var _toConsumableArray3=_interopRequireDefault(_toConsumableArray2);var _getPrototypeOf=__webpack_require__(65);var _getPrototypeOf2=_interopRequireDefault(_getPrototypeOf);var _classCallCheck2=__webpack_require__(68);var _classCallCheck3=_interopRequireDefault(_classCallCheck2);var _createClass2=__webpack_require__(69);var _createClass3=_interopRequireDefault(_createClass2);var _possibleConstructorReturn2=__webpack_require__(73);var _possibleConstructorReturn3=_interopRequireDefault(_possibleConstructorReturn2);var _inherits2=__webpack_require__(96);var _inherits3=_interopRequireDefault(_inherits2);var _react=__webpack_require__(104);var _react2=_interopRequireDefault(_react);var _classnames=__webpack_require__(105);var _classnames2=_interopRequireDefault(_classnames);function _interopRequireDefault(obj){return obj&&obj.__esModule?obj:{default:obj};}var ReactCodeInput=function(_Component){(0,_inherits3.default)(ReactCodeInput,_Component);function ReactCodeInput(props){(0,_classCallCheck3.default)(this,ReactCodeInput);var _this=(0,_possibleConstructorReturn3.default)(this,(ReactCodeInput.__proto__||(0,_getPrototypeOf2.default)(ReactCodeInput)).call(this,props));var value=props.value,fields=props.fields,type=props.type,isValid=props.isValid,disabled=props.disabled;_this.state={value:value,fields:fields,type:type,input:[],isValid:isValid,disabled:disabled};for(var i=0;i<Number(_this.state.fields);i+=1){if(i<32){var _value=[].concat((0,_toConsumableArray3.default)(_this.state.value))[i]||'';_this.state.input.push(_value);}}return _this;}(0,_createClass3.default)(ReactCodeInput,[{key:'componentWillReceiveProps',value:function componentWillReceiveProps(nextProps){this.setState({isValid:nextProps.isValid,value:nextProps.value,disabled:nextProps.disabled});}},{key:'handleBlur',value:function handleBlur(e){this.handleTouch(e.target.value);}},{key:'handleTouch',value:function handleTouch(value){if(typeof this.props.touch==='function'&&typeof this.props.untouch==='function'){if(value===''){this.props.touch(this.props.name);}else{this.props.untouch(this.props.name);}}}},{key:'handleChange',value:function handleChange(e){var target=Number(e.target.id);var value=String(e.target.value);if(value!==''){if(this.state.type==='number'){if(!value.match(/(\d)/g)){return;}if(value.length>1){this.refs[target].value=value.slice(-1);}}var input=this.state.input.slice();input[target]=this.refs[target].value;value=input.join('');this.setState({value:value,input:input});var newTarget=this.refs[target+1];if(newTarget){newTarget.focus();newTarget.select();}}if('onChange'in this.props){if(value){this.props.onChange(value);}}this.handleTouch(value);}},{key:'onKeyDown',value:function onKeyDown(e){var target=Number(e.target.id),prevTarget=this.refs[target-1];var input=void 0,value=void 0;switch(e.keyCode){case 8:e.preventDefault();this.refs[target].value='';input=this.state.input.slice();input[target]='';value=input.join('');this.setState({value:value,input:input});if(this.refs[target].value===''){if(prevTarget){prevTarget.focus();prevTarget.select();}}break;default:break;}if('onChange'in this.props){if(value){this.props.onChange(value);}}this.handleTouch(value);}},{key:'render',value:function render(){var _this2=this;var _props=this.props,className=_props.className,_props$style=_props.style,style=_props$style===undefined?{}:_props$style,_props$inputStyle=_props.inputStyle,inputStyle=_props$inputStyle===undefined?{}:_props$inputStyle,_props$inputStyleInva=_props.inputStyleInvalid,inputStyleInvalid=_props$inputStyleInva===undefined?{}:_props$inputStyleInva,type=_props.type,_state=this.state,disabled=_state.disabled,input=_state.input,isValid=_state.isValid,styles={container:style,input:isValid?inputStyle:inputStyleInvalid};(0,_assign2.default)(styles.container,{display:'inline-block'});if(!className&&(0,_keys2.default)(inputStyle).length===0){(0,_assign2.default)(inputStyle,{fontFamily:'monospace',borderRadius:'6px',border:'1px solid',boxShadow:'0px 0px 10px 0px rgba(0,0,0,.10)',margin:'4px',paddingLeft:'10px',width:'30px',height:'42px',fontSize:'32px',backgroundColor:'white',color:'black',MozAppearance:'textfield',borderColor:'lightgrey'});}if(!className&&(0,_keys2.default)(inputStyleInvalid).length===0){(0,_assign2.default)(inputStyleInvalid,{fontFamily:'monospace',borderRadius:'6px',border:'1px solid',boxShadow:'0px 0px 10px 0px rgba(0,0,0,.10)',margin:'4px',paddingLeft:'10px',width:'30px',height:'42px',fontSize:'32px',MozAppearance:'textfield',color:'#b94a48',backgroundColor:'#f2dede',borderColor:'#eed3d7'});}if(disabled){(0,_assign2.default)(styles.input,{cursor:'not-allowed',borderColor:'lightgrey',backgroundColor:'#efeff1'});}return _react2.default.createElement('div',{className:(0,_classnames2.default)(className,'react-code-input'),style:styles.container},input.map(function(value,i){return _react2.default.createElement('input',{ref:i,id:i,autoFocus:i===0?'autoFocus':'',defaultValue:value,key:'input_'+i,type:type,min:0,max:9,maxLength:1,style:styles.input,autoComplete:'off',onFocus:function onFocus(e){return e.target.select(e);},onBlur:function onBlur(e){return _this2.handleBlur(e);},onChange:function onChange(e){return _this2.handleChange(e);},onKeyDown:function onKeyDown(e){return _this2.onKeyDown(e);},disabled:disabled,'data-valid':isValid});}));}}]);return ReactCodeInput;}(_react.Component);ReactCodeInput.defaultProps={isValid:true,disabled:false,fields:4,value:'',type:'text'};ReactCodeInput.propTypes={options:_react.PropTypes.object,type:_react.PropTypes.oneOf(['text','number','password']),fields:_react.PropTypes.number,value:_react.PropTypes.string,onChange:_react.PropTypes.func,name:_react.PropTypes.string,touch:_react.PropTypes.func,untouch:_react.PropTypes.func,className:_react.PropTypes.string,isValid:_react.PropTypes.bool,disabled:_react.PropTypes.bool,style:_react.PropTypes.object,inputStyle:_react.PropTypes.object,inputStyleInvalid:_react.PropTypes.object};exports.default=ReactCodeInput;
	...
	module.exports = {
	  set: Object.setPrototypeOf || ('__proto__' in {} ? // eslint-disable-line
	    function(test, buggy, set){
	      try {
	        set = __webpack_require__(24)(Function.call, __webpack_require__(92).f(Object.prototype, '__proto__').set, 2);
	        set(test, []);
